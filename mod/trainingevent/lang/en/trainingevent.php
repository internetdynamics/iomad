...
$string['both'] = 'Manager and organization manager';
...
$string['companymanager'] = 'Organization manager';
...
$string['modulename_help'] = 'A training event allows for face to face training workshops to be added to a course.  It uses the organization defined training locations and can have a complex booking and approval method to allow access for users.';
