...
$string['blocktitle'] = 'Organization E-Commerce';
...
$string['commerce_externalshop_url_company'] = 'URL for organization specific external ecommerce site';
...
$string['exportproductcheckfull'] = 'This will save the selected product item as a template which can then be allocated to other organizations.';
$string['importproduct'] = 'Import product item';
$string['importproductcheckfull'] = 'This will create a new product item in the current organization shop from this template. Any courses which the current organization cannot see will be removed from the product so please check he product setings after import.';
...
$string['licenseoptionsavailableforregisteredcompanies'] = 'License options available for registered organizations, please login';
$string['loginforlicenseoptions'] = 'Please log in to see license options';
$string['managecompanyproducts'] = 'Manage organization products';
...
$string['opentoallcompanies'] = 'Shop is available to every organization';
$string['opentoallcompanies_help'] = 'If this is disabled, then access to the shop can be turned on on a per organization basis through the IOMAD control panel. If you enable it for the first time, you will then need to turn on the shop for the organizations who require it.';
$string['or'] = 'or';
$string['order'] = 'Order';
...
$string['privacy:metadata'] = 'The Organization E-Commerce block only shows data stored in other locations.';
...
$string['privacy:metadata:invoice:company'] = 'Invoice organization';
