...
$string['iomad_html:addinstance'] = 'Add a new Organization HTML block';
$string['iomad_html:myaddinstance'] = 'Add a new Organization HTML block to Dashboard';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['newiomad_htmlblock'] = '(new Organization HTML block)';
