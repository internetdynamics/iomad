...
$string['company_threads_for'] = 'Microlearning threads for organization {$a}';
...
$string['importthreadcheckfull'] = 'Are you sure you want to import thread {$a} and all associated nuggets to a new thread in this organization?  This does not copy over any currently assigned users.';
