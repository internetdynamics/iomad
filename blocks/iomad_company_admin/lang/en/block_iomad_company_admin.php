...
$string['addnewchildcompany'] = 'Add a new child organization';
$string['addnewcompany'] = 'Add a new organization';
...
$string['applyemailtemplate_help'] = 'Applying this email template will replace the current organization email template setting with those from the chosen email template set.';
$string['applyroletemplate'] = 'Apply role template (Previously applied was {$a})';
$string['assigncompetencytemplates'] = 'Assign organization learning plan templates';
$string['assigncompetencyframeworks'] = 'Assign organization competency frameworks';
...
$string['assigntocompany'] = 'Assign to organization';
...
$string['availabletemplates_help'] = 'These are the list of role templates which are available to organization managers when creating a child organization';
$string['backtocompanytemplate'] = 'Back to organization template';
...
$string['blocktitle'] = 'Organization / User Admin';
...
$string['closed'] = 'Shared'; // SEB
$string['choosecompletiontype'] = 'Select completion status';
$string['companycity'] = 'Location (Town/City)';
$string['companycityfilter'] = 'Organization location contains';
$string['companycode'] = 'Organization code';
$string['companycode_help'] = 'This is a unique identifier for this organization which can be used to tie the organization definition to an external system such as a Customer Relationship Management (CRM) system.';
$string['companycodetaken'] = 'Organization code is already in use in the system';
...
$string['companycount'] = '{$a} Organization';
$string['companycountplural'] = '{$a} Organizations';
$string['companycountryfilter'] = 'Organization country contains';
$string['companycourse'] = 'Course details';
$string['company_course_form_title'] = 'Manage organization courses';
$string['companycourses'] = 'Organization courses';
$string['company_courses'] = 'Courses';
$string['company_courses_for'] = 'Organization courses for \'{$a}\'';
$string['companycoursesmatching'] = 'Organization courses matching \'{$a}\'';
$string['company_course_users_title'] = 'Assign users to course';
$string['companycreated'] = 'Organization created';
$string['companycreatedok'] = 'Organization was created successfully';
...
$string['companydepartment'] = 'Organization departments for ';
$string['companydomains'] = 'List of organization domains';
$string['companydomains_help'] = 'This is the list of organization email domains which will be used to auto assign users to this organization through the local IOMAD signup plugin.';
$string['company_edit_advanced_title'] = 'Editing User';
$string['company_edit_users_title'] = 'Edit Users';
$string['company_edit_companies_title'] = 'Edit Organizations';
$string['companyfilter'] = 'Filter results';
$string['companyframeworks'] = 'Assign frameworks to organization';
$string['company_frameworks_for'] = 'Organization competency frameworks for \'{$a}\'';
$string['companygroups'] = 'Groups for ';
$string['companyhostname'] = 'Webserver hostname';
$string['companyhostname_help'] = 'If this is defined and the user accesses the site using this hostname they will be redirected to login page branded for this organization.';
$string['companyhostnametaken'] = 'Hostname is already used for another organization ({$a})';
$string['companymaxusers'] = 'Maximum active users';
$string['companymaxusers_help'] = 'This sets the maximum number of active users allowed for this organization.';
$string['companysuspendafter'] = 'Suspend after';
$string['companysuspendafter_help'] = 'If there is a contract end date for the organization, the organization and all if its users will be suspended after this timeframe.  The organization can be unsuspended but the contract end date will need to be updated first to prevent it from being suspended again.';
$string['companyterminateafter'] = 'Terminate after';
$string['companyterminateafter_help'] = 'If there is a contract end date for the organization, the organization and all if its users will be suspended after this timeframe.  If the Terminate after value is then set, then the organization will be terminated, with all licenses cleared down along with all current course enolments and interations.';
$string['companyvalidto'] = 'Contract end date';
$string['companyvalidto_help'] = 'This is the date after which all of the organizations users will be suspended along with the organization itself.  If there is a value for the "Terminate after" field, then all of the organization licenses and allof its active user course enrolments and interactions will removed. All reporting information is still kept.';
$string['compfromraw'] = 'Start date';
$string['comptoraw'] = 'End date';
$string['couldnotdeletecourse'] = 'Course could not be deleted';
$string['couldnotremovecoursefromcompany'] = 'Course could not be removed from the organization';
$string['currcompanyframeworks'] = 'Assigned frameworks';
$string['currcompanyframeworksmatching'] = 'Assigned frameworks matching\'{$a}\'';
$string['companyfavicon'] = 'Organization favicon';
$string['companyfavicon_desc'] = 'The favicon for the <i>currently selected</i> company is displayed next to the page title in the browser tab. A Moodle favicon is displayed if a custom favicon is not provided for either the organization or the site.';
$string['companylicensecreated'] = 'Organization license created';
$string['companylicensedeleted'] = 'Organization license deleted';
$string['companylicenseupdated'] = 'Organization license updated';
$string['company_license_list_title'] = 'Organization Licenses for {$a}';
...
$string['company_list_title'] = 'Organization Overview';
$string['companylogo'] = 'Organization logo';
...
$string['companylogocompact'] = 'Organization compact logo';
...
$string['companymanagement'] = 'Organizations';
$string['company_manager_form_title'] = 'Assign department users/managers';
$string['companymanager'] = 'Organization manager';
$string['companymanagers'] = 'Organization managers';
$string['company_managers_for'] = 'Organization managers for \'{$a}\'';
$string['company_managers'] = 'Managers';
$string['companymanagersmatching'] = 'Organization managers matching \'{$a}\'';
$string['companyname'] = 'Long Name';
$string['companynamefilter'] = 'Organization name contains';
$string['companynametaken'] = 'Long name is already used for another organization ({$a})';
$string['companyoverview'] = 'Organization overview';
$string['companyprofilefields'] = ' Organization Additional Profile Fields';
$string['companyprofileshortname'] = 'Short name (must be unique)';
$string['companyreporters'] = 'Organization reporters';
$string['companysavedok'] = 'Organization details saved successfully';
$string['companyadvancedsearchfields'] = 'Organization advanced search fields';
$string['companysearchfields'] = 'Organization search fields';
$string['companyshortname'] = 'Short Name';
$string['companyshortnametaken'] = 'Short name is already used for another organization ({$a})';
$string['company_showgrade'] = 'Display course grade on organization certificate';
$string['company_showgrade_help'] = 'If you are using the organization certificate type then unchecking this will remove any text for the user\'s grade for this organization';
$string['companysuspended'] = 'Organization suspended';
$string['company_templates_for'] = 'Organization learning plan templates for {$a}';
$string['companyterminated'] = 'Organization terminated';
$string['companytemplates'] = 'Assign learning plan templates to organization';
$string['companyupdated'] = 'Organization updated';
$string['companyunsuspended'] = 'Organization un-suspended';
$string['company_uselogo'] = 'Display logo on organization certificate';
$string['company_uselogo_help'] = 'If you are using the organization certificate type then unchecking this will remove any certificate seal image for this organization';
$string['company_usesignature'] = 'Display signature on organization certificate';
$string['company_usesignature_help'] = 'If you are using the organization certificate type then unchecking this will remove any certificate signature image for this organization';
$string['company_useborder'] = 'Display border on organization certificate';
$string['company_useborder_help'] = 'If you are using the organization certificate type then unchecking this will remove any certificate border image for this organization';
$string['company_usewatermark'] = 'Display watermark on organization certificate';
$string['company_usewatermark_help'] = 'If you are using the organization certificate type then unchecking this will remove any certificate watermark image for this organization';
$string['currcompanytemplates'] = 'Assigned templates';
$string['currcompanytemplatesmatching'] = 'Assigned templates matching \'{$a}\'';
$string['currentcompany'] = 'Your organization is \'{$a}\'';
$string['companyadvanced'] = 'Advanced Organization Settings';
$string['company_competency_framework_form_title'] = 'Manage organization competency frameworks';
$string['company_competency_template_form_title'] = 'Manage organization learning plan templates';
$string['companyuser'] = 'Organization user ({$a})';
$string['companyuserassigned'] = 'Organization user assigned';
$string['company_user_form_title'] = 'Assign users to organization';
$string['companyusers'] = 'Organization users';
$string['company_users_course_title'] = 'Manage user enrolments';
$string['company_users_for'] = 'Organization users for \'{$a}\'';
$string['companyusersmatching'] = 'Organization users matching \'{$a}\'';
$string['company_users'] = 'Users';
$string['companyuserunassigned'] = 'Organization user unassigned';
...
$string['coursenamesearch'] = 'Search for course';
...
$string['createcompany'] = 'Create organization';
...
$string['createnewcompany'] = 'Create a new organization';
$string['createchildcompany'] = 'Create child organization';
...
$string['customcss'] = 'Custom organization CSS';
$string['dashboard'] = 'Organization dashboard';
$string['departmentprofileid'] = 'Department profile field';
$string['departmentprofileid_help'] = 'if you have set up self authentication and you have a menu profile field which users can use on this form and there is a matching organization department, then you can use this to allow users to be automatically assigned to that department.';
$string['custom1'] = 'Custom 1';
$string['custom2'] = 'Custom 2';
$string['custom3'] = 'Custom 3';
$string['dashboard'] = 'Organization dashboard';
$string['datefilter'] = 'Filter by date';
$string['deleteanddestroycoursesfull'] = 'Are you sure you want to delete course {$a}? Clicking continue will remove all current user enrolments, any license allocations and the course from the organization. If you click destroy, it will also remove all of the user reords from the all reports. <b>There is no recovery from this without backup</b>';
$string['deletecoursesfull'] = 'Are you sure you want to delete course {$a}? Clicking continue will remove all current user enrolments, any license allocations and the course from the organization. <b>There is no recovery from this without backup</b>';
$string['deletecheckfull'] = 'Do you really want to delete this user';
$string['deletecompany'] = 'Delete organization';
...
$string['deleteroletemplatefull'] = 'Are you sure you want to remove this role template?  This does not remove any restrictions from organizations, it simply removes this template as an option which can be applied.';
...
$string['deletedepartmentcheckfull'] = 'Are you absolutely sure you want to delete department {$a} and all of it\'s sub-departments?  This will not delete the default organization department';
...
$string['designatedcompany'] = 'Designated organization';
...
$string['editacompany'] = 'Edit a organization';
$string['editcompany'] = 'Edit organization';
$string['edit_companies_title'] = 'Channel settings';
...
$string['edituser'] = 'Manage users';
$string['educator'] = 'Course educator';
$string['educator_help'] = 'Course educators get teacher type roles within organization courses.';
...
$string['filtercompany'] = 'Organizations';
$string['firstcompany'] = 'You must create at least one organization before you can use IOMAD';
...
$string['invaliddepartmentjson'] = 'The file imported does not match the organization structure.';
...
$string['iomaddashboard'] = 'Organization dashboard';
$string['iomad_company_admin:addinstance'] = 'Add a new Channel admin block';
$string['iomad_company_admin:assign_groups'] = 'Assign users to organization groups';
$string['iomad_company_admin:assign_company_manager'] = 'Assign a organization manager';
$string['iomad_company_admin:assign_company_reporter'] = 'Assign a organization reporter';
...
$string['iomad_company_admin:allcompany_user_profiles'] = 'Manage all user profiles for all organizations';
...
$string['iomad_company_admin:company_add'] = 'Add a organization';
$string['iomad_company_admin:company_add_child'] = 'Add a child organization';
$string['iomad_company_admin:canviewchildren'] = 'Can view child organizations of current organization';
$string['iomad_company_admin:company_course'] = 'Add a course to a organization';
$string['iomad_company_admin:company_course_unenrol'] = 'Add/remove a course with existing enrolments';
$string['iomad_company_admin:company_course_users'] = 'Enrol/unenrol users on organization courses';
$string['iomad_company_admin:company_delete'] = 'Delete a organization';
$string['iomad_company_admin:company_edit'] = 'Edit a organization';
$string['iomad_company_admin:company_edit_appearance'] = 'Edit the organization appearance';
$string['iomad_company_admin:company_edit_certificateinfo'] = 'Edit the organization certificate options';
$string['iomad_company_admin:company_framework'] = 'Assign competency frameworks to a organization';
$string['iomad_company_admin:company_manager'] = 'Organization manager form';
$string['iomad_company_admin:companymanagement_view'] = 'View organization management tab';
$string['iomad_company_admin:company_template'] = 'Assign learning plan templates to a organization';
$string['iomad_company_admin:company_user'] = 'Organization user form';
$string['iomad_company_admin:company_user_profiles'] = 'Manage all user profiles for organization';
$string['iomad_company_admin:company_view_all'] = 'View all organizations';
$string['iomad_company_admin:company_view'] = 'View list of organizations';
...
$string['iomad_company_admin:edit_all_departments'] = 'Edit all organization departments';
$string['iomad_company_admin:editallusers'] = 'Manage users in every organization';
$string['iomad_company_admin:edit_departments'] = 'Edit own organization departments';
$string['iomad_company_admin:edit_groups'] = 'Edit organization course groups';
$string['iomad_company_admin:edit_licenses'] = 'Edit organization licenses';
$string['iomad_company_admin:edit_my_licenses'] = 'Edit my organization licenses';
$string['iomad_company_admin:editmanagers'] = 'Edit organization managers in own organization';
$string['iomad_company_admin:editusers'] = 'Manage users in own organization';
$string['iomad_company_admin:edituserpassword'] = 'Resend password details to users in own organization';
$string['iomad_company_admin:export_departments'] = 'Export organization departments to a file';
$string['iomad_company_admin:deleteuser'] = 'Delete users in own organization';
$string['iomad_company_admin:suspenduser'] = 'Suspend users in own organization';
$string['iomad_company_admin:company_license_users'] = 'Modify user license allocations';
$string['iomad_company_admin:import_departments'] = 'Import organization departments from a file';
...
$string['iomad_company_admin:deletecourses'] = 'Delete a non-shared organization course';
$string['iomad_company_admin:destroycourses'] = 'Delete a non-shared organization course and remove all held user data for it.';
$string['iomad_company_admin:manageallcourses'] = 'Manage organization courses for all organizations and courses';
$string['iomad_company_admin:managecourses'] = 'Manage organization courses';
$string['iomad_company_admin:viewcourses'] = 'View organization courses';
$string['iomad_company_admin:viewallsharedcourses'] = 'View all closed shared courses not just parent organization ones';
...
$string['iomad_company_admin:myaddinstance'] = 'Add a new Channel admin block to the users dashboard';
$string['iomad_company_admin:restrict_capabilities'] = 'Restrict IOMAD role capabilties for organization';
$string['iomad_company_admin:split_my_licenses'] = 'Split a license to a child organization';
$string['iomad_company_admin:suspendcompanies'] = 'Suspend a organization';
$string['iomad_company_admin:templateview'] = 'View templates from dashboard';
$string['iomad_company_admin:unallocate_licenses'] = 'Unallocate licenses from organization';
...
$string['iomad_company_admin:view_licenses'] = 'View organization licenses';
$string['iomad_company_admin:view_my_company_email'] = 'Unused ';
$string['iomad_company_admin:view'] = 'View a organization';
$string['isdefaultgroupdelete'] = 'This is the default organization course group.  You can edit it but not delete it.';
...
$string['hide_suspended_companies'] = 'Hide suspended organizations?';
$string['invalid_company'] = 'Optional field profile_field_company must match your organization\'s shortname.';
$string['inuse'] = 'In use';
...
$string['managecompanies'] = 'Manage organizations';
$string['managecompany'] = 'Manage organization';
$string['managecourses'] = 'Select';
$string['managegroups'] = 'Manage organization groups';
$string['managelicenses'] = 'License management';
$string['managemanagers'] = 'Select';
$string['managementtitle'] = 'Organization, User and Course Management';
$string['manager'] = 'Manager';
$string['manageremails'] = 'Manager emails';
$string['managernotify'] = 'Send manager emails';
$string['managernotify_help'] = 'Choose what type of notifications a organization manager will get for their users.  Whether it is reminder emails to complete a course or course completion information for users or both.';
...
$string['maxuserswarningplural'] = 'Adding these users will increase the total number of active users in organization beyond the maximum allowed ({$a}). You will need to either suspend or delete some current users or contact the site administrator to increase the allowed value.';
$string['missingcompany'] = 'Missing organization';
...
$string['nocompanies'] = 'There are no organizations - please add a organization first';
$string['nocompaniesfilter'] = 'No organizations match your current filter';
$string['nocompaniesfound'] = 'There are no organizations which match your criteria';
$string['nocompany'] = 'Unallocated courses';
$string['nocompanyframeworks'] = 'Unallocated competency frameworks';
$string['nocompanyselected'] = 'No organization is selected. Please make a selection above';
...
$string['noneselected'] = 'No organization selected';
...
$string['open'] = 'Public'; // SEB
$string['no'] = 'Private'; // SEB
$string['optionalfieldserror'] = 'Error reading optional fields';
$string['iomad_company_courses_title'] = 'Manage organization courses';
...
$string['iomad_courses_title'] = 'Manage organization courses';
$string['iomadreports'] = 'Organization reports';
$string['parentcompany'] = 'Parent organization';
$string['parentcompany_help'] = 'Select the parent organization for this organization.  Organization managers in the parent organization will automatically be assigned as organization managers in this organization and licenses can be split from a parent organization to a child organization.';
$string['parentcompanysuspended'] = 'Organization cannot be un-suspended without it\'s parent organization';
...
$string['pleaseselect'] = 'Please select a organization from the dropdown box on the Dashboard page';
$string['pluginname'] = 'Organization / User Admin';
...
$string['privacy:metadata'] = 'The Organization admin block only shows data stored in other locations.';
$string['profile_field_company_not_empty_does_not_match_selected'] = 'profile_field_company is not empty and does not match the selected organization.';
$string['profile_field_company_not_set'] = 'profile_field_company is required when no organization has been selected.';
...
$string['roletemplate_help'] = 'Select the role template to be applied to this organization.  Child organizations can inherit as well as use a template which is allocated to the organization.  This will change all of the organization and department managers capabilities for this organization';
$string['roletemplatename'] = 'Role template name';
$string['roletemplatename_help'] = 'This is the name which the template will be saved as.  You can select this when creating organizations';
...
$string['saveasnewcompany'] = 'Save new organization';
$string['saveroletemplate'] = 'Save as role template';
$string['savetemplate'] = 'Save template';
$string['selectacompany'] = 'Select a organization';
...
$string['shared_help'] = '<ul><li><b>No</b> - Course is not shared</li><li><b>Open sharing</b> - Course is shared across <b>all</b> companies</li><li><b>Closed sharing</b> - Course is shared between selected organizations (see <i>Course management > Assign to organization</i>)</li></ul>';
$string['shared_framework_help'] = '<ul><li><b>No</b> - Framework is not shared</li><li><b>Open sharing</b> - Framework is shared across <b>all</b> companies</li><li><b>Closed sharing</b> - Framework is shared between selected organizations (see <i>Competency management > Assign framework to organization</i>)</li></ul>';
$string['shared_template'] = 'sharing competency template settings';
$string['shared_framework'] = 'sharing competency framework settings';
$string['shared_template_help'] = '<ul><li><b>No</b> - Template is not shared</li><li><b>Open sharing</b> - Template is shared across <b>all</b> companies</li><li><b>Closed sharing</b> - Template is shared between selected organizations (see <i>Competency management > Assign template to organization</i>)</li></ul>';
...
$string['showallcompanies'] = 'Show all organizations';
$string['show_all_company_users'] = 'Show users from every organization?';
$string['showcharts'] = 'Display as charts';
$string['showdata'] = 'Display as table';
$string['showcompanydetail'] = 'Show department detail';
$string['showcompanysummary'] = 'Show organization summary';
$string['showhierarchy'] = 'Show hierarchy';
$string['showhistoricusers'] = 'Show historic results';
$string['showothermanagers'] = 'Show external organization managers';
$string['showothermanagers_help'] = 'Select this if you would like to show organization managers from other organizations.  This is only available if the role type you are assigning is the organization manager one.';
$string['showpercentagecourseusers'] = 'Percentage of course';
$string['showpercentageusers'] = 'Percentage of organization';
$string['show_suspended_companies'] = 'Show suspended organizations?';
$string['split'] = 'Split';
...
$string['suspendcompany'] = 'Suspend organization';
$string['suspendcompanycheck'] = 'Do you really want to suspend this organization?';
$string['suspendcompanycheckfull'] = 'Do you really want to suspend this organization?  This will suspend all of the users who are associate to this organization but will keep the courses and other organization details intact.';
...
$string['unsuspendcompany'] = 'Unsuspend organization';
$string['unsuspendcompanycheck'] = 'Do you really want to unsuspend this organization?';
$string['unsuspendcompanycheckfull'] = 'Do you really want to unsuspend this organization?  This will unsuspend all of the users who are associate to this organization.';
...
$string['upload_no_company_no_courses'] = 'Courses can only be selected when a organization is selected.';
$string['upload_no_company_selected'] = 'No organization selected, profile_field_company must be present in the uploaded file.';
...
$string['archetypecompanymanager_role'] = 'Organization manager';
$string['companymanager_role'] = 'Organization manager';
$string['archetypecompanydepartmentmanager_role'] = 'Organization department manager';
$string['companydepartmentmanager_role'] = 'Organization department manager';
$string['archetypecompanycourseeditor_role'] = 'Organization course editing teacher';
$string['companycourseeditor_role'] = 'Organization course editing teacher';
$string['archetypecompanycoursenoneditor_role'] = 'Organization course non editing teacher';
$string['companycoursenoneditor_role'] = 'Organization course non editing teacher';
$string['archetypeclientreporter_role'] = 'Organization report only';
$string['clientreporter_role'] = 'Client report only';
$string['clientreporter'] = 'Client report only';
$string['archetypecompanyreporter_role'] = 'Organization report only';
$string['companyreporter_role'] = 'Organization report only';
$string['companyreporter'] = 'Organization report only';
