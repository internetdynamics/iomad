...
$string['iomad_autoenrol_managers_help'] = 'If this is unticked then manager accounts will not be enrolled as the organization teacher roles on manual enrol courses ';
$string['iomad_autoreallocate_licenses'] = 'Automatically re-allocate license';
$string['iomad_autoreallocate_licenses_help'] = 'If this is ticked then when a user\'s licensed course entry is deleted within the user report then the system will automatically try to re-allocate another from the organization license pool';
$string['iomadcertificate_logo'] = 'Default logo for Organization certificate';
$string['iomadcertificate_signature'] = 'Default signature for Organization certificate';
$string['iomadcertificate_border'] = 'Default border for Organization certificate';
$string['iomadcertificate_watermark'] = 'Default watermark for Organization certificate';
$string['iomadcertificate_logodesc'] = 'This is the default logo image used for the Organization certificate type. You can override it in the organization edit pages. The uploaded image should be 80 pixels high and have a transparent background.';
$string['iomadcertificate_signaturedesc'] = 'This is the default signature image used for the Organization certificate type. You can override it in the organization edit pages. The uploaded image should be 31 pixels x 150 pixels and have a transparent background';
$string['iomadcertificate_borderdesc'] = 'This is the default border image used for the Organization certificate type. You can override it in the organization edit pages. The uploaded image should be 800 pixels x 604 pixels.';
$string['iomadcertificate_watermarkdesc'] = 'This is the default watermark image used for the Organization certificate type. You can override it in the organization edit pages. The uploaded image should be no more than 800 pixels x 604 pixels.';
...
$string['iomad_max_list_companies'] = 'Maximum listed organizations';
$string['iomad_max_list_companies_help'] = 'This defines the maximum number of organizations displayed on a page';
...
$string['iomad_sync_department'] = 'Sync organization department with profile';
$string['iomad_sync_department_help'] = 'Selecting this will keep the user profile field for department in sync with the name of the organization department that the user is in.';
$string['iomad_sync_institution'] = 'Sync organization name with profile';
$string['iomad_sync_institution_help'] = 'Selecting this will keep the user profile field for institution in sync with the shortname of the organization that the user is in.';
...
$string['iomad_useicons'] = 'Use icons in Organization dashboard';
...
$string['sampleonbehalfof'] = 'On behalf of Organization';
